      ...
      <article className="relative py-12 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={addRef(2)} className="story-section mb-16 md:mb-24">
            ...
            <p className="story-body">
              I was at the company kickoff for one of our enterprise customers, HiveMQ — a $35M SaaS business. Their executive leadership team was demoing the suite of agents we&apos;d built for them. One by one they walked through the tools: onboarding agent, support agent, SDR agent. Polite applause. Good stuff.
            </p>
